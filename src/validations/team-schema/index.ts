...
//  short_name: Yup.string().required('Team short name is required to fill!'),
  ...
  phone_num: Yup.string().required('Phone numbers of the coaches are required for the printed schedules, so leaving it empty does not work. Please re-enter their phone numbers.'),
