...
1. PUT: https://api.tourneymaster.org/v1/events?event_id=[VARCHAR]
...
1. POST: https://api.tourneymaster.org/v1/facilities?facilities_id=[NUMBER]
...
1. PUT: https://api.tourneymaster.org/v1/fields?fields_id=[VARCHAR]
...
1. PUT: https://api.tourneymaster.org/v1/games?game_id=[VARCHAR]
...
1. PUT: https://api.tourneymaster.org/v1/members?member_id=[VARCHAR]
...
1. PUT: https://api.tourneymaster.org/v1/registrations?registration_id=[VARCHAR]
